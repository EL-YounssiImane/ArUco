...
int main(int argc, char * argv[])
{
    ...
    int choix; //pour choisir quel partie du programme on veut compiler
    cout << endl;
    cout << "****************CHOIX PROGRAMME A COMPILER****************" << endl;
    cout << endl << " --> Quelle partie voulez-vous compiler ?" << endl;
    cout << endl << " --> Choisissez '1' pour la 1ere partie - premier programme" << endl;
    cout << endl <<" --> Choisissez '2' pour l'application RA ou partie 3 premiere augmentation - voir PS en dessous" << endl;
    cout << endl << "PS : vous pouvez decommenter les lignes 280 - 291 - 292 du code 'ArUco-OpenGL.cpp' pour compiler la partie '3- Premiere augmentation' et puis choisissez '2'" << endl;

    cin >> choix;

    if (choix == 1)
    {
        /*1 ERE PARTIE - PREMIER PROGRAMME*/
